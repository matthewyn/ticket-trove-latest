  ...
  return (
    <section className="lg:mt-12">
      <div className="relative h-80 lg:hidden">
        <Image src={`https://image.tmdb.org/t/p/w300${movie.poster}`} alt={`${movie.title} poster`} quality={80} fill objectFit="cover" />
      </div>
      <div className="max-w-6xl mx-auto grid lg:grid-cols-[1fr_3fr] px-8 gap-8">
        <div className="hidden lg:block">
          <Image src={`https://image.tmdb.org/t/p/w300${movie.poster}`} width={290} height={216} alt={`${movie.title} poster`} quality={80} priority={true} />
        </div>
